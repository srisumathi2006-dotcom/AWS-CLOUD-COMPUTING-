...
🔄 Project Workflow
Developed the Hospital Web Application using Python (Flask).
...
Configured a ClusterIP Service.
Configured a NodePort Service.
Configured a LoadBalancer Service.
Created a ConfigMap for application configuration.
Created a Secret for sensitive information.
