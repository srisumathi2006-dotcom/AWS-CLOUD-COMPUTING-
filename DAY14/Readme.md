...
🏗️ Architecture
Developer │ ▼ GitHub Repository │ ▼ Jenkins CI Pipeline │ ├── Build ├── Test ├── Trivy Scan ├── Docker Build └── Push to Docker Hub │ ▼ Update Kubernetes Manifests │ ▼ Argo CD │ ▼ AWS EKS Cluster │ ┌──────────┼──────────┐ ▼ ▼ ▼ Frontend Backend Database │ ▼ Prometheus Monitoring │ ▼ Grafana Dashboards
